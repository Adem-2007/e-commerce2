// frontend/src/pages/Dashboard/Hero/components/hero/HeroModalCreate.jsx
    ...
    <>
      ...
      <div dir={activeLang === "ar" ? "rtl" : "ltr"}>
        <label className="block text-sm font-medium text-gray-700">
          {t("hero_control.modal_create.label_title")}
        </label>
      ...
      <div dir={activeLang === "ar" ? "rtl" : "ltr"}>
        <label className="block text-sm font-medium text-gray-700">
          {t("hero_control.modal_create.label_category")}
        </label>
        <div className="relative mt-1">
          <span className="absolute inset-y-0 left-0 flex items-center pl-3 rtl:left-auto rtl:right-0 rtl:pr-3">
      ...
      <div dir={activeLang === "ar" ? "rtl" : "ltr"}>
        <label className="block text-sm font-medium text-gray-700">
          {t("hero_control.modal_create.label_description")}
        </label>
        <div className="relative mt-1">
...
const HeroModalCreate = ({ isOpen, onClose, onSave, isSaving }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!imageFile)
      return setValidationError(
        t("hero_control.modal_create.error_asset_required")
      );
          ...
          >
            <div className="flex items-center justify-between p-4 border-b border-gray-200 flex-shrink-0">
              <h3 className="text-lg font-semibold text-black">
                {t("hero_control.modal_create.title")}
                      ...
                      {!imagePreview ? (
                        <div className="text-center text-gray-500 p-4">
                          ...
                          <p className="mt-2 font-semibold text-gray-800">
                            {t("hero_control.modal_create.upload_prompt_main")}
                          </p>
                          <p className="text-xs text-gray-500 mt-1">
                            {t("hero_control.modal_create.upload_prompt_sub")}
                          </p>
                        </div>
                      ) : (
                        <img
            ...
            <div className="p-4 border-t border-gray-200 flex-shrink-0 bg-white">
              ...
              <div className="flex md:hidden justify-between items-center gap-4">
                {step === 1 ? (
                  ...
                  >
                    {t("hero_control.modal_create.button_abort")}
                  </button>
                ) : (
                  <button
                    type="button"
                ...
                {step === 1 ? (
                  ...
                  >
                    {isSaving ? (
                      ...
                      t("hero_control.modal_create.button_execute")
                    )}
                  </button>
                )}
              </div>
...
export default HeroModalCreate;
