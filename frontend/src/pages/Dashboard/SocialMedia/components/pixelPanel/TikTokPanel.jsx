// src/pages/Dashboard/SocialMedia/components/pixelPanel/TikTokPanel.jsx
        ...
        <>
            ...
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
                <AddPixelModal
                    ...
                    platformColor="#000000" // TikTok's official black
                    tokenIdentifier="tiktok"
                />
            </Modal>
            ...
            <div className="space-y-8 animate-fadeIn">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <button 
                        ...
                        className="w-full md:w-auto flex items-center justify-center gap-2 px-4 py-3 text-sm font-semibold text-white bg-black rounded-lg shadow-sm hover:bg-gray-800 transition-colors"
                    >
                        <PlusCircle size={18} />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    <StatCard icon={<BarChartBig size={22} className="text-black" />} title={t('social_media_page.pixel_panels.stats_total')} value={data.length} />
